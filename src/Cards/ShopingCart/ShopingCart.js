...
const ShopingCart = () => {
  const { cart, removeFromCart, clearCart } = useContext(CoursContext);
  return (
    // <div>
    //   <h2>Shopping Cart</h2>
    // {cart.map((product, index) => (
    //   <div key={index}>
    //     <p>{product.courseName}</p>
    //     <p>{product.price}</p>
        ...
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                className="bg-blue-800  text-white rounded-lg p-3 font-semibold  text-center"
                onClick={() => clearCart()}
              >
                Clear-Cart
              </button>
