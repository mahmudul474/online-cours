...
const UniversityTestAdmissionMap = ({universityTestData}) => {

    const {id, courseImg, coursePrice, videoCount, chapter, courseName} = universityTestData;
    ...
    <div className="card card-compact bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="flex justify-between text-center mt-3 font-semibold">
              <p> <i class="fa-regular fa-clock"></i> {videoCount}+ Videos</p>
              <p> <i class="fa-regular fa-clock"></i> {chapter}+ Chapter</p>
            </div>
