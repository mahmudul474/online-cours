  ...
  return (
    ...
    <div className="mx-0 lg:mx-8 py-5">
      ...
      {/* fvrt icon */}
        ...
        <div className="dropdown dropdown-end">
         ...
         <label tabIndex={0} className="btn btn-ghost btn-circle ml-12 lg:ml-0 md:ml-0 ">

         <div className="indicator">

         <i className="fa-regular fa-heart text-lg ml-12 lg:ml-0 md:ml-0 "></i>
    ...
    {/* add to card */}
        ...
        <div className="dropdown dropdown-end">
         ...
         <div className="indicator">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-6 lg:ml-0 md:ml-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
    ...
    <div className="dropdown dropdown-end">
      <label tabIndex={0} className="btn btn-ghost btn-circle">
        ...
        <span className="badge badge-xs badge-primary indicator-item mr-0 lg:mr-5">4</span>
        </div>
      </label>
